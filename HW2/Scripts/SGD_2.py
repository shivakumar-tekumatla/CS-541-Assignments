import numpy as np 
class SGD:
    def __init__(self,X_tr,ytr,X_te,yte,n=[100,200,300],epsilon=[0.000001,0.0000001,0.00000001],epochs=[2,3,4],alpha=[2,3,4]) -> None:
    ...
    def stochastic_gradient_descent(self):
        ...
        # No we found the best hyper parameter set 
